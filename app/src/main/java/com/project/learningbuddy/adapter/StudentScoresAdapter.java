...
public class StudentScoresAdapter extends FirestoreRecyclerAdapter<QuizAttempts, StudentScoresAdapter.ClassesHolder> {
    /**
     ...
     * @param options
     */
    public StudentScoresAdapter(@NonNull FirestoreRecyclerOptions<QuizAttempts> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull StudentScoresAdapter.ClassesHolder holder, int position, @NonNull QuizAttempts model) {
    ...
    @NonNull
    @Override
    public StudentScoresAdapter.ClassesHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
