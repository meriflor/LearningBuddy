...
public class ClassListTeacherAdapter extends FirestoreRecyclerAdapter<TeacherClass, ClassListTeacherAdapter.ClassesHolder> {
    /**
     ...
     * @param options
     */
    public ClassListTeacherAdapter(@NonNull FirestoreRecyclerOptions<TeacherClass> options) {
        super(options);
    }
    ...
    @Override
    protected void onBindViewHolder(@NonNull ClassListTeacherAdapter.ClassesHolder holder, int position, @NonNull TeacherClass model) {
