...
public class PerfectScoresAdapter extends FirestoreRecyclerAdapter<QuizAttempts, PerfectScoresAdapter.ClassesHolder> {
    /**
     ...
     * @param options
     */
    public PerfectScoresAdapter(@NonNull FirestoreRecyclerOptions<QuizAttempts> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull PerfectScoresAdapter.ClassesHolder holder, int position, @NonNull QuizAttempts model) {
    ...
    @NonNull
    @Override
    public PerfectScoresAdapter.ClassesHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
